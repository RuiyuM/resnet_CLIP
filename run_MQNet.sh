...
do
	...
	do
		...
		do
			...
			CUDA_VISIBLE_DEVICES=7 python MQNet.py --gpu 7 --k $i --save-dir log_AL/ --weight-cent 0 --query-strategy $method --init-percent 8 --known-class 20 --query-batch $j --seed 3 --model ResNet18 --known-T 0.5 --unknown-T 0.5 --modelB-T 1 --dataset cifar100 &

			CUDA_VISIBLE_DEVICES=8 python MQNet.py --gpu 8 --k $i --save-dir log_AL/ --weight-cent 0 --query-strategy $method --init-percent 1 --known-class 2 --query-batch $j --seed 1 --model ResNet18 --known-T 0.5 --unknown-T 0.5 --modelB-T 1 --dataset cifar10 &
			CUDA_VISIBLE_DEVICES=9 python MQNet.py --gpu 9 --k $i --save-dir log_AL/ --weight-cent 0 --query-strategy $method --init-percent 1 --known-class 2 --query-batch $j --seed 2 --model ResNet18 --known-T 0.5 --unknown-T 0.5 --modelB-T 1 --dataset cifar10 &
